  ...
  return (
    <div>
      ...
      <div className='bottom-text'>
          <div className='text-white opacity-[0.6] font-semibold'>@aayushah711</div>
      </div>
...
const SideImages=({setStepCount})=>{
    return(
        <div className='flex flex-col items-center mr-2'>
            ...
            <div className='mt-6 opacity-[0.6] text-black bg-[white] rounded-[50%] p-1' onClick={setStepCount}>
                Buy
            </div>
        </div>
    )
